...
def main() -> int:
    ...
    sd_filter = eol.join(
        (
            ...
            b"",
            b"  // The platform PMIC table already programmed both rails to 2.96V.",
            b"  // Reprogramming a disabled rail stalls this firmware; only enable it.",
            b"  Print (L\"Calling enable PMIC_C L9/VDD...\\r\\n\");",
            ...
            b"",
            b"  gBS->Stall (1000);",
            b"  PrintSdRailStatus (Vreg, T860_PM_LDO_9, L\"L9/VDD after enable\");",
            b"  Print (L\"Calling enable PMIC_C L6/VDD_IO...\\r\\n\");",
    ...
    sd_case = eol.join(
        (
            ...
            b"        }",
            b"",
            b"        Print (L\"\\r\\nT860 SDCC VREG ENABLE-ONLY + EVENT DIAGNOSTIC\\r\\n\");",
    ...
    report = {
        ...
        "purpose": "enable the preconfigured T860 SD card rails PM8150L L9 and L6 without reprogramming voltage, use the native T860 SdccDxe, signal Qualcomm's fixed external-SD event group, enumerate storage, then boot only a root startup.nsh volume",
        "sd_power": {
            "pmic_index": 2,
